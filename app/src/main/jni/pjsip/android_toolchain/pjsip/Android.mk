...
LOCAL_SRC_FILES := $(PJSIP_SRC_DIR)/sip_config.c $(PJSIP_SRC_DIR)/sip_multipart.c \
		...
		$(PJSIPUA2_SRC_DIR)/account.cpp $(PJSIPUA2_SRC_DIR)/call.cpp $(PJSIPUA2_SRC_DIR)/endpoint.cpp \
		$(PJSIPUA2_SRC_DIR)/json.cpp $(PJSIPUA2_SRC_DIR)/media.cpp $(PJSIPUA2_SRC_DIR)/persistent.cpp \
		$(PJSIPUA2_SRC_DIR)/presence.cpp $(PJSIPUA2_SRC_DIR)/siptypes.cpp $(PJSIPUA2_SRC_DIR)/types.cpp 
